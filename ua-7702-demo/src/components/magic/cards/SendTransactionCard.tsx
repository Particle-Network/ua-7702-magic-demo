...
const SendTransaction = () => {
  ...
  const sendTransaction = useCallback(async () => {
    ...
    if (isEip1559Supported()) {
      ...
      txnParams.maxFeePerGas = BigInt(feeData.maxFeePerGas ?? 0);
      txnParams.maxPriorityFeePerGas = BigInt(feeData.maxPriorityFeePerGas ?? 0);
    } else {
      txnParams.gasPrice = String(await web3.eth.getGasPrice());
    }
